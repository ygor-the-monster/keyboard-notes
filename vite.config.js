    ...
    VitePWA({
      ...
      manifest: {
        ...
        screenshots: [
          ...
          {
            src: "screenshots/tool-chords-wide.png",
            sizes: "1440x900",
            type: "image/png",
            form_factor: "wide",
            label: "The chord tool — build a chord, see its spelling and guitar/ukulele shapes",
          },
          {
            src: "screenshots/tool-chords-narrow.png",
            sizes: "412x915",
            type: "image/png",
            form_factor: "narrow",
            label: "The chord tool on a phone",
          },
          {
            src: "screenshots/tool-practice-wide.png",
            sizes: "1440x900",
            type: "image/png",
            form_factor: "wide",
            label: "The practice timer — daily goal, streak and history",
          },
          {
            src: "screenshots/tool-practice-narrow.png",
            sizes: "412x915",
            type: "image/png",
            form_factor: "narrow",
            label: "The practice timer on a phone",
          },
          {
            src: "screenshots/tool-syntax-wide.png",
            sizes: "1440x900",
            type: "image/png",
            form_factor: "wide",
            label: "The syntax reference — full cheat sheet and copyable practice templates",
          },
          {
            src: "screenshots/tool-syntax-narrow.png",
            sizes: "412x915",
            type: "image/png",
            form_factor: "narrow",
            label: "The syntax reference on a phone",
          },
        ],
        ...
        shortcuts: [
          ...
          },
          {
            name: "Drone",
            short_name: "Drone",
            description: "Open the drone",
            url: "./?tool=drone",
            icons: [{ src: "icons/shortcut-drone.png", sizes: "192x192", type: "image/png" }],
          },
          {
            name: "Chords",
            short_name: "Chords",
            description: "Open the chord reference",
            url: "./?tool=chords",
            icons: [{ src: "icons/shortcut-chords.png", sizes: "192x192", type: "image/png" }],
          },
          {
            name: "Practice timer",
            short_name: "Practice",
            description: "Open the practice timer",
            url: "./?tool=practice",
            icons: [{ src: "icons/shortcut-practice.png", sizes: "192x192", type: "image/png" }],
          },
          {
            name: "Scratchpad",
            short_name: "Scratchpad",
            description: "Open the scratchpad",
            url: "./?tool=scratchpad",
            icons: [{ src: "icons/shortcut-scratchpad.png", sizes: "192x192", type: "image/png" }],
          },
          {
            name: "Syntax reference",
            short_name: "Syntax",
            description: "Open the syntax reference",
            url: "./?tool=syntax",
            icons: [{ src: "icons/shortcut-syntax.png", sizes: "192x192", type: "image/png" }],
          },
        ],
